...
public final class BlueHawaiiSkillCatalog {
    ...
    public static final String HUNT_ACTIVATE_ICON = "jojoplaguesurge:textures/skill/tracking_player.png";
    public static final String HUNT_RELEASE_ICON = "jojoplaguesurge:textures/skill/cancel_skill.png";
